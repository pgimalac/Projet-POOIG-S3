...
public class NouveauPanel extends JPanelUp{
	...
	public void goTo(){
		...
		ButtonUp menu=new ButtonUp("Retourner au menu",true,true,event -> super.parent.fireGoToMenu());
	...
	private void choisirJoueurs(boolean oie){
		...
		tmp.add(new ButtonUp("Retourner au menu",true,true, event -> super.parent.fireGoToMenu()));
		boutons.add(tmp);
